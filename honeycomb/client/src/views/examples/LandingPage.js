...
import Wade from "../../assets/img/chester-wade.jpg";
      ...
      <div className="wrapper">
        <div className="page-header">
          <img
            alt="..."
            className="path"
            src={require(Blob).default}
          />
          <img
            alt="..."
            className="path2"
            src={require(Path2).default}
          />
          <img
            alt="..."
            className="shapes triangle"
            src={require(Triun).default}
          />
          <img
            alt="..."
            className="shapes wave"
            src={require(Waves).default}
          />
          <img
            alt="..."
            className="shapes squares"
            src={require(Patrat).default}
          />
          <img
            alt="..."
            className="shapes circle"
            src={require(Cercuri).default}
          />
